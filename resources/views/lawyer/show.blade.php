    ...
    <x-slot name="header">
        <form method="POST" action="{{ route('lawyer.cases.delete', [$courtCase->id]) }}">
            ...
            <a href="{{ route('lawyer.dashboard') }}"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg w-full sm:w-auto px-5 py-2.5 text-center mr-4">
                View Cases
            </a>
            ...
            <a href="" onclick="event.preventDefault();
                ...
                class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg w-full sm:w-auto px-5 py-2.5 text-center">
                Delete
            </a>
        </form>
    </x-slot>
                    ...
                    @foreach ($courtCase->documents as $document)
                        <div class="pt-8">
                            ...
                            <a href="{{ $document->path }}"
                                class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center me-2 mb-2">
                                Download
                            </a>
                        </div>
                    @endforeach
                        ...
                        <div
                            ...
                            <div class="mt-6">
                                <form method="POST"
                                    ...
                                    this.closest('form').submit();"
                                        class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg px-5 py-2.5 text-center me-2 mb-2">
                                        Delete
                                    </a>
                                </form>
                            </div>
